 ...
 *
 * Similar to scikit-learn's LinearDiscriminantAnalysis, a classifier
 * with shared covariance across classes.
 */
class LinearDiscriminantAnalysis : public Estimator, public Classifier {
private:
    double regularization_;
    bool fitted_;
    int n_features_;
    ...
    MatrixXd covariance_inv_;

public:
    LinearDiscriminantAnalysis(double regularization = 0.0);

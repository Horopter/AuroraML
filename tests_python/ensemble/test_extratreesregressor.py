#!/usr/bin/env python3
"""
Test Suite for IngenuityML ExtraTreesRegressor Algorithm
...
class TestExtraTreesRegressor(unittest.TestCase):
    """Test ExtraTreesRegressor algorithm - Positive and Negative Cases"""
    ...
    def test_basic_functionality(self):
        ...
        model = ing_module.ExtraTreesRegressor(n_estimators=10, random_state=42)

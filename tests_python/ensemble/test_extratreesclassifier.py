#!/usr/bin/env python3
"""
Test Suite for IngenuityML ExtraTreesClassifier Algorithm
...
class TestExtraTreesClassifier(unittest.TestCase):
    """Test ExtraTreesClassifier algorithm - Positive and Negative Cases"""
    ...
    def test_basic_functionality(self):
        ...
        model = ing_module.ExtraTreesClassifier(n_estimators=10, random_state=42)

#!/usr/bin/env python3
"""
Test Suite for IngenuityML HistGradientBoostingRegressor Algorithm
...
class TestHistGradientBoostingRegressor(unittest.TestCase):
    """Test HistGradientBoostingRegressor algorithm - Positive and Negative Cases"""
    ...
    def test_basic_functionality(self):
        ...
        import ingenuityml.gradient_boosting as ing_module

        model = ing_module.HistGradientBoostingRegressor(max_iter=10, random_state=42)

...
import random
"""
Test Suite for IngenuityML Metrics
...
class TestClassificationMetrics(unittest.TestCase):
    ...
    def test_accuracy_score(self):
        ...
        accuracy = ing_metrics.accuracy_score(self.y_true, self.y_pred)
    ...
    def test_accuracy_score_perfect(self):
        ...
        accuracy = ing_metrics.accuracy_score(self.y_true, self.y_true)
    ...
    def test_accuracy_score_worst(self):
        ...
        accuracy = ing_metrics.accuracy_score(self.y_true, y_worst)
    ...
    def test_accuracy_score_edge_cases(self):
        ...
        # Single sample
        accuracy = ing_metrics.accuracy_score([0], [0])
        self.assertEqual(accuracy, 1.0)
        
        # All same class
        y_all_zeros = np.zeros(10)
        accuracy = ing_metrics.accuracy_score(y_all_zeros, y_all_zeros)
        self.assertEqual(accuracy, 1.0)
    ...
    def test_precision_score(self):
        ...
        precision = ing_metrics.precision_score(y_true_reshaped, y_pred_reshaped, "macro")
    ...
    def test_recall_score(self):
        ...
        recall = ing_metrics.recall_score(y_true_reshaped, y_pred_reshaped, "macro")
    ...
    def test_f1_score(self):
        ...
        f1 = ing_metrics.f1_score(y_true_reshaped, y_pred_reshaped, "macro")
    ...
    def test_confusion_matrix(self):
        ...
        cm = ing_metrics.confusion_matrix(self.y_true, self.y_pred)
...
class TestRegressionMetrics(unittest.TestCase):
    ...
    def test_mean_squared_error(self):
        ...
        mse = ing_metrics.mean_squared_error(self.y_true, self.y_pred)
    ...
    def test_mean_absolute_error(self):
        ...
        mae = ing_metrics.mean_absolute_error(self.y_true, self.y_pred)
    ...
    def test_r2_score(self):
        ...
        r2 = ing_metrics.r2_score(self.y_true, self.y_pred)
    ...
    def test_r2_score_perfect(self):
        ...
        r2 = ing_metrics.r2_score(self.y_true, self.y_true)
    ...
    def test_r2_score_worst(self):
        ...
        r2 = ing_metrics.r2_score(self.y_true, y_mean)
    ...
    def test_mean_squared_log_error(self):
        ...
        # MSLE is not implemented in IngenuityML, skip this test
        self.skipTest("mean_squared_log_error not implemented in IngenuityML")
    ...
    def test_edge_cases(self):
        ...
        # Single sample
        mse = ing_metrics.mean_squared_error([1.0], [1.0])
        self.assertEqual(mse, 0.0)
        
        # Identical arrays
        y_identical = np.array([1.0, 2.0, 3.0])
        mse = ing_metrics.mean_squared_error(y_identical, y_identical)
        self.assertEqual(mse, 0.0)
        
        # Zero variance - R2 should be NaN for constant arrays
        y_constant = np.array([1.0, 1.0, 1.0])
        r2 = ing_metrics.r2_score(y_constant, y_constant)
...
class TestMetricsIntegration(unittest.TestCase):
    ...
    def test_classification_metrics_consistency(self):
        ...
        accuracy = ing_metrics.accuracy_score(y_true, y_pred)
        precision = ing_metrics.precision_score(y_true_reshaped, y_pred_reshaped, "macro")
        recall = ing_metrics.recall_score(y_true_reshaped, y_pred_reshaped, "macro")
        f1 = ing_metrics.f1_score(y_true_reshaped, y_pred_reshaped, "macro")
    ...
    def test_regression_metrics_consistency(self):
        ...
        mse = ing_metrics.mean_squared_error(y_true, y_pred)
        mae = ing_metrics.mean_absolute_error(y_true, y_pred)
        r2 = ing_metrics.r2_score(y_true, y_pred)
    ...
    def test_metrics_with_different_data_types(self):
        ...
        acc_1d = ing_metrics.accuracy_score(y_true_1d, y_pred_1d)
        acc_2d = ing_metrics.accuracy_score(y_true_2d, y_pred_2d)
    ...
    def test_metrics_performance(self):
        ...
        accuracy = ing_metrics.accuracy_score(y_true_class, y_pred_class)
        self.assertGreaterEqual(accuracy, 0.0)
        self.assertLessEqual(accuracy, 1.0)
        ...
        mse = ing_metrics.mean_squared_error(y_true_reg, y_pred_reg)
        self.assertGreaterEqual(mse, 0.0)
        
        r2 = ing_metrics.r2_score(y_true_reg, y_pred_reg)
        self.assertLessEqual(r2, 1.0)
...
class TestAdditionalClassificationMetrics(unittest.TestCase):
    ...
    def test_balanced_accuracy_score(self):
        ...
        balanced_acc = ing_metrics.balanced_accuracy_score(self.y_true, self.y_pred)
    ...
    def test_roc_auc_score(self):
        ...
        roc_auc = ing_metrics.roc_auc_score(self.y_true, self.y_score)
    ...
    def test_average_precision_score(self):
        ...
        ap = ing_metrics.average_precision_score(self.y_true, self.y_score)
    ...
    def test_log_loss(self):
        ...
        log_loss_val = ing_metrics.log_loss(self.y_true, self.y_proba)
    ...
    def test_hinge_loss(self):
        ...
        hinge = ing_metrics.hinge_loss(self.y_true, decision)
    ...
    def test_cohen_kappa_score(self):
        ...
        kappa = ing_metrics.cohen_kappa_score(self.y_true, self.y_pred)
    ...
    def test_matthews_corrcoef(self):
        ...
        mcc = ing_metrics.matthews_corrcoef(self.y_true, self.y_pred)
    ...
    def test_hamming_loss(self):
        ...
        hamming = ing_metrics.hamming_loss(self.y_true, self.y_pred)
    ...
    def test_jaccard_score(self):
        ...
        jaccard = ing_metrics.jaccard_score(self.y_true, self.y_pred, "macro")
    ...
    def test_zero_one_loss(self):
        ...
        zero_one = ing_metrics.zero_one_loss(self.y_true, self.y_pred)
    ...
    def test_brier_score_loss(self):
        ...
        brier = ing_metrics.brier_score_loss(self.y_true, self.y_score)
...
class TestAdditionalRegressionMetrics(unittest.TestCase):
    ...
    def test_median_absolute_error(self):
        ...
        median_ae = ing_metrics.median_absolute_error(self.y_true, self.y_pred)
    ...
    def test_max_error(self):
        ...
        max_err = ing_metrics.max_error(self.y_true, self.y_pred)
    ...
    def test_mean_poisson_deviance(self):
        ...
        poisson_dev = ing_metrics.mean_poisson_deviance(self.y_true_positive, self.y_pred_positive)
    ...
    def test_mean_gamma_deviance(self):
        ...
        gamma_dev = ing_metrics.mean_gamma_deviance(self.y_true_positive, self.y_pred_positive)
    ...
    def test_mean_tweedie_deviance(self):
        ...
        tweedie_dev = ing_metrics.mean_tweedie_deviance(self.y_true_positive, self.y_pred_positive, 1.5)
    ...
    def test_d2_tweedie_score(self):
        ...
        d2 = ing_metrics.d2_tweedie_score(self.y_true_positive, self.y_pred_positive, 1.0)
    ...
    def test_d2_pinball_score(self):
        ...
        d2_pinball = ing_metrics.d2_pinball_score(self.y_true, self.y_pred, 0.5)
    ...
    def test_d2_absolute_error_score(self):
        ...
        d2_ae = ing_metrics.d2_absolute_error_score(self.y_true, self.y_pred)
...
class TestClusteringMetrics(unittest.TestCase):
    ...
    def test_silhouette_score(self):
        ...
        silhouette = ing_metrics.silhouette_score(self.X, self.labels)
    ...
    def test_silhouette_samples(self):
        ...
        samples = ing_metrics.silhouette_samples(self.X, self.labels)
    ...
    def test_calinski_harabasz_score(self):
        ...
        ch_score = ing_metrics.calinski_harabasz_score(self.X, self.labels)
    ...
    def test_davies_bouldin_score(self):
        ...
        db_score = ing_metrics.davies_bouldin_score(self.X, self.labels)
    ...
    def test_adjusted_rand_score(self):
        ...
        ari = ing_metrics.adjusted_rand_score(self.labels_true, self.labels_pred)
    ...
    def test_adjusted_mutual_info_score(self):
        ...
        ami = ing_metrics.adjusted_mutual_info_score(self.labels_true, self.labels_pred)
    ...
    def test_normalized_mutual_info_score(self):
        ...
        nmi = ing_metrics.normalized_mutual_info_score(self.labels_true, self.labels_pred)
    ...
    def test_homogeneity_score(self):
        ...
        homogeneity = ing_metrics.homogeneity_score(self.labels_true, self.labels_pred)
    ...
    def test_completeness_score(self):
        ...
        completeness = ing_metrics.completeness_score(self.labels_true, self.labels_pred)
    ...
    def test_v_measure_score(self):
        ...
        v_measure = ing_metrics.v_measure_score(self.labels_true, self.labels_pred)
    ...
    def test_fowlkes_mallows_score(self):
        ...
        fm_score = ing_metrics.fowlkes_mallows_score(self.labels_true, self.labels_pred)

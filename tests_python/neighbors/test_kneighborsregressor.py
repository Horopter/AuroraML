#!/usr/bin/env python3
"""
Test Suite for AuroraML KNeighborsRegressor Algorithm
...
class TestKNeighborsRegressor(unittest.TestCase):
    """Test KNeighborsRegressor algorithm - Positive and Negative Cases"""
    ...
    def test_basic_functionality(self):
        ...
        model = aml_module.KNeighborsRegressor(n_neighbors=5)
